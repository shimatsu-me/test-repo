...
## [ユーザーフロー][リクエスト予約]店舗の詳細から web 予約

＜＜＜ 準備中 ＞＞＞

## [ユーザーフロー][リクエスト予約]店舗の詳細から電話予約

＜＜＜ 準備中 ＞＞＞

- 「集客強化店舗」（ibj_reserve で管理）のみ電話予約可

## [ユーザーフロー][TableCheck予約]店舗の詳細 →TC サイトで予約

＜＜＜ 準備中 ＞＞＞

## [ユーザーフロー][アフィリエイト予約]店舗一覧 → 各予約サイトで予約
